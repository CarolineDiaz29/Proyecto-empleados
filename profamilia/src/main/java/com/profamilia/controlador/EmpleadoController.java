...
public class EmpleadoController implements Serializable {
    ...
    public EmpleadoController() {
        ...
        listaSedes = sedeDao.obtenerTodasLasSedes();
    }
    ...
    public String crearempleado() {
        try {
            calcularEdad();
            Sede sede = sedeDao.obtenerSedePorId(empleado.getSede().getIdsede());
            if (sede == null) {
                throw new IllegalAccessException("La sede no existe.");
            }
            empleado.setSede(sede);
            empleadoDao.crearEmpleado(empleado);
            empleados = empleadoDao.obtenerEmpleadosPorSede(empleado.getSede().getIdsede());
    ...
    public void consultarEmpleadosPorSede() {
        try {
            ...
            empleados = empleadoDao.obtenerEmpleadosPorSede(idsede);
